/* Original source:  https://picoledelimao.github.io/blog/2015/11/15/fingertip-detection-on-opencv/ */
#include <Rcpp.h>
#include <iostream>
...
void CallbackFunc(int event, int x, int y, int flags, void* userdata)
{
  ...
  Rcpp::Rcout << pixel << std::endl; 
}
*/

/* int main() */
RcppExport SEXP finger_detect(SEXP cameraId) {
BEGIN_RCPP
