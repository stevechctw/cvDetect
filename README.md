...
If you feel uncomfortable to download binary files in 1. and 2. in this page, you can build it yourself by installing [ROpenCVLite](https://github.com/swarm-lab/ROpenCVLite)  package and copy all the files and sub-directories under the compiled "opencv" directory it build to a new directory (e.g. d:\ROpencv). The compiled "opencv" directory can be located in, e.g., d:\R\R-3.4.0\library\ROpenCVLite .
